...
: m_pImplementation(new CNetworkEngine_Impl())
{
...
ENetworkErrorCodes TerrainEngine::CNetworkEngine::RegisterNode(std::string strHostname, uint16_t uPort, std::vector<char> vKey)
{
