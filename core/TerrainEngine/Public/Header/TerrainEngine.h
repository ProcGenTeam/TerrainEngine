...
public:
    // Methods
    CTerrainEngine(FLOAT_TYPE fWaterLevel, uint32_t uWidth, uint32_t uHeight, int32_t iXOffset = 0,
    ...
    // Generation
    //
    void Erode(uint32_t uLayerIndex, uint32_t uSteps, uint32_t uTerrainLayerIndex = UINT32_MAX,
    ...
    void FractalPerlin(uint32_t uLayerIndex, float fScale, uint32_t uLevels);
