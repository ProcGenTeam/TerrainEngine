...
CRenderEngine::CRenderEngine(FCameraSettings &stSettings)
: m_implementation(new CRenderEngine_Impl(stSettings))
{
...
void CRenderEngine::MarchedRender(std::string filename, std::shared_ptr<std::vector<FLOAT_TYPE>> terrainView, uint32_t uTerrainWidth)
{
